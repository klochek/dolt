...
/**
 * Selection view on dense 1-d matrices.
 */
class SelectedDenseMatrix1d extends Matrix1d {
   ...
   */
  SelectedDenseMatrix1d(int size, List<double> elements, int zero, int stride,
   ...
   * Constructs a matrix view with the given parameters.
   */
  SelectedDenseMatrix1d.fromElements(List<double> elements, List<int> offsets) :
  ...
  void operator[]=(int index, double value) {
    _elements[_actualOffset + _offsets[_zero + index * _stride]] = value;
  }
